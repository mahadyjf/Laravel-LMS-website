    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <p class="footer-text"><i class="fas fa-phone"></i> 01876748718 </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> mahadyjf@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link"  href="/trams">ফেরত নীতি</a><br>
                <a class="footer-link" href="/policy">শর্ত সমূহ </a><br>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব মাহদী জামান দ্বারা সংরক্ষিত; ২০২০-২০২১ </p>
</div>
